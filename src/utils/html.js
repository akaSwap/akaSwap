...
export async function validateFiles(files) {
  ...
  if (!doc.head) {
    return {
      valid: false,
      error:
        'Missing <head> tag in index.html. Please refer to the Interactive akaOBJs Guide..',
    }
  }
  ...
  //     valid: false,
  //     error:
  //       'Missing cover image <meta> tag in index.html. Please refer to the Interactive akaOBJs Guide.',
  //   }
  // }
  ...
  // let dot_ind = coverImagePath.lastIndexOf('.');
  // let uppercase = "";
  // if(dot_ind>=0){
  //   uppercase = coverImagePath.substring(0,dot_ind+1) + coverImagePath.substring(dot_ind+1).toUpperCase()
  // }
  // if (!files[coverImagePath] && !files[uppercase]) {
  // if (!files[coverImagePath]) {
  //   return {
  //     valid: false,
  //     error: `Missing cover image ${coverImagePath}. Please refer to the Interactive akaOBJs Guide.`,
  //   }
  // }
